...
class DocAnalyserApp(SettingsMixin, LocalAIMixin, DocumentFetchingMixin, OCRProcessingMixin, LibraryInteractionMixin, ViewerThreadMixin, ProcessOutputMixin, ExportUtilitiesMixin):
